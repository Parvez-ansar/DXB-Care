...
const CorporateSlider = () => {
  const slideData = [
    { image: NewAssistingImage, label: "Web3 Events" },
    { image: NewPartiesImage, label: "Proposals" },
    { image: NewWellnessImage, label: "Parties Access" },
    { image: NewLegalImage, label: "Special Events" },
  ];
